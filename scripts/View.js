...
define(function(require, exports, module) {
  'use strict';
	...
	View.addMouseEvents = function addMouseEvents(el, fnOnClick)
	{
		if (el.id)
		{
	...
	View.removeMouseEvents = function removeMouseEvents(el, fnOnClick)
	{
		if (el.id)
		{
			var mouse = View.events[el.id];
			if (mouse)
			{
				el.removeEventListener('mousemove', mouse.onMouseMove, false);
				...
				View.events[el.id] = null;
			}
		}
	}
	
	View.getMouse = function getMouse(el)
	{
		return View.events[el.id];
	}
	
	View.calculateClickPointAndVector = function calculateClickPointAndVector(scene, mousex, mousey)
	{
	...
	View.getIntersectedObjects = function getIntersectedObjects(scene, clickPoint, clickVector)
	{
