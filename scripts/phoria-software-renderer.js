/**
 * @fileoverview phoria - Software renderer is based on the work by mr.doob which in turn is based on the work here:
...
define(function(require, exports, module) {
  'use strict';
    ...
    * standard canvas poly drawing - but does not have anti-aliasing and is notably slower for large polygons.
    */
   var SoftwareRenderer = function(canvas)
   {
      SoftwareRenderer.superclass.constructor.call(this);
   ...
   Phoria.Util.extend(SoftwareRenderer, Renderer, {
