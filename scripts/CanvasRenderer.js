...
define(function(require, exports, module) {
   ...
   {
      CanvasRenderer.superclass.constructor.call(this);
   ...
   Util.extend(CanvasRenderer, Renderer, {
      ...
      renderPolygon: function renderPolygon(ctx, obj, scene, poly)
      {
         ...
         switch (obj.style.shademode)
         {
            ...
            case "lightsource":
            {
               ...
               rgb = this.calcNormalBrightness(Util.averagePolyVertex(vertices, obj._worldcoords), poly._worldnormal, scene, obj);
