...
define(function(require, exports, module) {
  'use strict';
   ...
   {
      EmitterEntity.superclass.constructor.call(this);
    ...
    * }
    */
   EmitterEntity.create = function create(desc)
   {
   ...
   Phoria.Util.extend(EmitterEntity, BaseEntity, {
       ...
       * 
       * @param fn {function}    onParticle handler signature: function(particle) this = EmitterEntity,
